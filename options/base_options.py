...
class BaseOptions():
	...
	def initialize(self):
		...
		self.parser.add_argument('--data_dir', type=str, default=os.getenv('PT_DATA_DIR', 'E:/Research/Videos/FAIR-Play/'), help='Directory where dataset is stored. This has been generated by download_data.py')
		self.parser.add_argument('--output_dir', type=str, default=os.getenv('PT_OUTPUT_DIR', 'E:/Source/2.5D-Visual-Sound/'), help='Directory to save model and summaries')

		self.parser.add_argument('--audio_dir', type=str, default='binaural_audios')
		self.parser.add_argument('--frames_dir', type=str, default='frames')
	...
	def parse(self):
		...
		# save to the disk
		expr_dir = os.path.join(self.opt.output_dir, self.opt.checkpoints_dir, self.opt.name)
