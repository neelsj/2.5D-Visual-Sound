...
class BaseOptions():
	...
	def initialize(self):
		...
		self.parser.add_argument('--data_dir', type=str, default=os.getenv('PT_DATA_DIR', 'data'), help='Directory where dataset is stored. This has been generated by download_data.py')
		self.parser.add_argument('--output_dir', type=str, default=os.getenv('PT_OUTPUT_DIR', '.'), help='Directory to save model and summaries')
